...
\ RETURNS REVERT REVOKE ROLLBACK ROWCOUNT ROWGUIDCOL RULE SAVE SCHEMA
...
\ THEN TO TOP TRAN TRANSACTION TRIGGER TRUNCATE TSEQUAL UNIQUE UNPIVOT UPDATE
\ UPDATETEXT USE VALUES VARYING VIEW WAITFOR WHEN WHERE WHILE WITH WRITETEXT
